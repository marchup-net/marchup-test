...
class HelloWorldUser(HttpUser):
    ...
    def on_start(self):
        ...
        self.testSpace1containerID = self.client.get(
            f"/space/{constants.testSpaceID}", headers=self.authtoken
        ).json()['contentcontainer_id']
    ...
    @task(1)
    def mail(self):
        self.client.get("/mail", headers=self.authtoken)
